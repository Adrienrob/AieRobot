...
void ChoseSkillMenu::drawScreens(RenderWindow* window){

	//window.create(VideoMode(1800,height), title);
	...
	while(window->isOpen()){
		...
		window->draw(this->rectcapteur);
		window->draw(this->rectarme);
		window->draw(this->border);
		window->draw(this->border2);
		window->draw(this->textcap);
		window->draw(this->textarme);
		...
		window->draw(this->cap1);
		window->draw(this->cap2);
		window->draw(this->cap3);
		window->draw(this->cap4);
		window->draw(this->circ1);
		window->draw(this->erase);
		window->draw(this->circ2);
		window->draw(this->start);
		
		
		if(this->cap1.getGlobalBounds().contains(sf::Vector2f(mousePos))){
			window->draw(this->textcap1);
			window->draw(this->prendre);
			window->draw(this->rectcap1);
			window->draw(this->bordertab1);
			window->draw(this->titre1);
			window->draw(this->sstitre1);
			window->draw(this->sstitres1);
		...
		if(this->cap2.getGlobalBounds().contains(sf::Vector2f(mousePos))){
			window->draw(this->textcap2);
			window->draw(this->prendre2);
			window->draw(this->rectcap2);
			window->draw(this->bordertab2);
			window->draw(this->titre2);
			window->draw(this->sstitre2);
			window->draw(this->sstitres2);
		...
		if(this->cap3.getGlobalBounds().contains(sf::Vector2f(mousePos))){
			window->draw(this->textcap3);
			window->draw(this->pret);
			window->draw(this->rectcap3);
			window->draw(this->bordertab3);
			window->draw(this->titre3);
			window->draw(this->sstitre3);
			window->draw(this->sstitres3);
		...
		if(this->cap4.getGlobalBounds().contains(sf::Vector2f(mousePos))){
			window->draw(this->textcap4);
			window->draw(this->pret2);
			window->draw(this->rectcap4);
			window->draw(this->bordertab4);
			window->draw(this->titre4);
			window->draw(this->sstitre4);
			window->draw(this->sstitres4);
		...
		if(this->circ2.getGlobalBounds().contains(sf::Vector2f(mousePos))){
			if((sf::Mouse::isButtonPressed(sf::Mouse::Left))&&(choix_arme==1)&&(choix_cap==1)){
				...
				choix_arme=2;
				choix_cap=2;
                this->ProchainScreen = "PlateauJeu";
                //cout << "Entrée DANS LE JEU" << endl;
				// Lancement du jeu
			}
		}
...
{
	MapBoutons["PlateauJeu"] = new Bouton(0, 0, 0, 0, "Valide",  sf::Color(20,20,100,200),false);

    MapBoutons["Quit"] = new Bouton(0, 0, 0, 0, "Quit",  sf::Color(100,20,20,200),false);
}
